...
useEffect(()=>{
 loadOrderData()
  ...
  return (
    <div className='w-[99vw] min-h-[100vh] p-[20px] pb-[150px]  overflow-hidden bg-[#c8b9a9]'>
            ...
            <div key={index} className='w-[100%] h-[10%] border-t border-b '>
                <div className='w-[100%] h-[80%] flex items-start gap-6 bg-[#b3997f]  py-[10px] px-[20px] rounded-2xl relative '>
                    ...
                    <div className='absolute md:left-[55%] md:top-[40%] right-[2%] top-[2%]  '>
                      ...
                      <p className='min-w-2 h-2 rounded-full bg-black-500'></p> 
                    ...
                    <button className='md:px-[15px] px-[5px] py-[3px] md:py-[7px] rounded-md bg-[#c8b9a9] text-[black] text-[12px] md:text-[16px] cursor-pointe active:bg-[#b3997f]' onClick={loadOrderData} >Track Order</button>
                  </div>
                    </div>
                </div>
