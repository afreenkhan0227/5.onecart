...
function Collections() {
  ...
  return (
    <div className='w-[99vw]  min-h-[100vh] bg-[#c8b9a9] flex items-start flex-col md:flex-row justify-start  pt-[70px] overflow-x-hidden z-[2] pb-[110px]'>
      <div className={`md:w-[30vw] lg:w-[20vw] w-[100vw] md:min-h-[100vh] ${showFilter ? "h-[45vh]" :"h-[8vh]"}  p-[20px] border-r-[1px] border-black  text-[black] lg:fixed `}>
        ...
        <div className={`border-[2px] border-[black] pl-5 py-3 mt-6 rounded-md bg-[#b3997f] ${showFilter ? "" : "hidden"} md:block`}>
            <p className='text-[18px] text-[black]'>CATEGORIES</p>
            <div className='w-[230px] h-[180px]  flex items-start justify-center gap-[10px] flex-col'>
                <p className='flex items-center justify-center gap-[10px] text-[16px] font-light'> <input type="checkbox" value={'Men'} className='w-3' onChange={toggleCategory} /> Men</p>
                 <p className='flex items-center justify-center gap-[10px] text-[16px] font-light'> <input type="checkbox" value={'Women'} className='w-3' onChange={toggleCategory} /> Women</p>
                  ...
                  <p className='flex items-center justify-center gap-[10px] text-[16px] font-light'> <input type="checkbox" value={'Hijabs'} onChange={toggleCategory} className='w-3' /> Hijabs</p>
        ...
        <div className={`border-[2px] border-[black] pl-5 py-3 mt-15 rounded-md bg-[#b3997f] ${showFilter ? "" : "hidden"} md:block`}>
      ...
      <div className='lg:pl-[20%] md:py-[10px] '>
        <div className=' md:w-[80vw] w-[100vw]    flex  justify-between flex-col lg:flex-row lg:px-[50px] '>
            ...
            <select name="" id="" className='bg-[#b3997f] w-[60%] md:w-[200px] h-[50px] px-[10px] text-[black] rounded-lg hover:border-[black] border-[2px] ' onChange={(e)=>SetSortType(e.target.value)}>
